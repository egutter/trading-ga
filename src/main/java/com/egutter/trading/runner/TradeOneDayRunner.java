...
//                new Candidate("Aggressive lastQ2014",   "100110110001010111001000101000", asList(MovingAverageConvergenceDivergenceGenerator.class, RelativeStrengthIndexGenerator.class)),
                new Candidate("B Less Consv 2013-2014",   "110001100010100010011110110100", asList(MovingAverageConvergenceDivergenceGenerator.class, RelativeStrengthIndexGenerator.class)),
                ...
                new Candidate("C Consv Log10 2013-2014",  "011100111001111110100110101011", asList(MovingAverageConvergenceDivergenceGenerator.class, RelativeStrengthIndexGenerator.class)),
...
//                new Candidate("Aggressive 2013-2014",   "111111110100000110100010110011", asList(MovingAverageConvergenceDivergenceGenerator.class, MoneyFlowIndexGenerator.class)),
                new Candidate("B Less Consv 2013-2014",   "110001100010101100100010100100", asList(MovingAverageConvergenceDivergenceGenerator.class, MoneyFlowIndexGenerator.class)),
                new Candidate("X Less Consv 2013-2014",   "110000010111101100010010000100", asList(MovingAverageConvergenceDivergenceGenerator.class, MoneyFlowIndexGenerator.class)),
                ...
                new Candidate("A Consv Log10 2013-2014",  "110001100001001100000110111100", asList(MovingAverageConvergenceDivergenceGenerator.class, MoneyFlowIndexGenerator.class)),
                new Candidate("B Consv Log10 2013-2014",  "010101100001100110000110101100", asList(MovingAverageConvergenceDivergenceGenerator.class, MoneyFlowIndexGenerator.class)),
...
//                new Candidate("Aggressive lastQ2014",   "010111101100011001000110111110", asList(RelativeStrengthIndexGenerator.class, MoneyFlowIndexGenerator.class)),
                ...
                new Candidate("A Consv Log10 2013-2014",    "010001100111001111110010111110", asList(RelativeStrengthIndexGenerator.class, MoneyFlowIndexGenerator.class)),
...
//                new Candidate("Aggressive 2013-2014",   "111111100100010000000010011000", asList(MovingAverageConvergenceDivergenceGenerator.class, AroonOscilatorGenerator.class)),
                new Candidate("A Less Consv 2013-2014",   "111001100000011010100010100101", asList(MovingAverageConvergenceDivergenceGenerator.class, AroonOscilatorGenerator.class)),
                ...
                new Candidate("C Consv LogE 2013-2014",   "010000101010111110110110001110", asList(MovingAverageConvergenceDivergenceGenerator.class, AroonOscilatorGenerator.class)),
                new Candidate("Z Consv Log10 2013-2014",  "000111010111001010000010111010", asList(MovingAverageConvergenceDivergenceGenerator.class, AroonOscilatorGenerator.class)),
                new Candidate("D Consv Log10 2013-2014",  "000100001100101110100011000010", asList(MovingAverageConvergenceDivergenceGenerator.class, AroonOscilatorGenerator.class)),
...
//                new Candidate("Aggressive lastQ2014",     "111111000001110111011110101010", asList(MovingAverageConvergenceDivergenceGenerator.class, BollingerBandsGenerator.class)),
                new Candidate("B Less Consv 2013-2014",     "101101100001111000100010101010", asList(MovingAverageConvergenceDivergenceGenerator.class, BollingerBandsGenerator.class)),
                ...
                new Candidate("A Consv LogE 2013-2014",     "110001100011000111111001010000", asList(MovingAverageConvergenceDivergenceGenerator.class, BollingerBandsGenerator.class)),
                ...
                new Candidate("X Conservative 2014", "00100101011111111", asList(MovingAverageConvergenceDivergenceGenerator.class)),
                ...
                new Candidate("A Conservative 2014",      "10010110001100111", asList(BollingerBandsGenerator.class)),
...
//                new Candidate("Aggressive lastQ2014",   "11111011110010010", asList(BollingerBandsGenerator.class)),
                ...
                new Candidate("Z Conservative 2014",      "00000111011110101", asList(RelativeStrengthIndexGenerator.class)),
                new Candidate("Z Conservative 2014",      "00000111011110110", asList(RelativeStrengthIndexGenerator.class)),
...
//                new Candidate("Aggressive 2013-2014", "11110011010000100", asList(MoneyFlowIndexGenerator.class)),
                ...
                new Candidate("C Conservative 2014",        "111101100100101110101110100111", asList(BollingerBandsGenerator.class, MoneyFlowIndexGenerator.class)),
                new Candidate("B Conservative 2014",        "101101100011011110101001110111", asList(BollingerBandsGenerator.class, MoneyFlowIndexGenerator.class)),
                new Candidate("C Less Consv 2013-2014",     "111101100110011110000010111011", asList(BollingerBandsGenerator.class, MoneyFlowIndexGenerator.class)),
                new Candidate("B Consv Log10 2013-2014",    "001101100011011110011001110011", asList(BollingerBandsGenerator.class, MoneyFlowIndexGenerator.class)),
...
//                new Candidate("Aggressive lastQ2014",   "010110111100100101101110111100", asList(BollingerBandsGenerator.class, RelativeStrengthIndexGenerator.class)),
                ...
                new Candidate("C Less Consv 2013-2014",     "111101100100101110011110101111", asList(BollingerBandsGenerator.class, RelativeStrengthIndexGenerator.class)),
                new Candidate("C Less Consv 2013-2014",     "111101100110001110001010010011", asList(BollingerBandsGenerator.class, RelativeStrengthIndexGenerator.class)),
                new Candidate("B Consv LogE 2013-2014",     "010001100011011110010001101001", asList(BollingerBandsGenerator.class, RelativeStrengthIndexGenerator.class)),
                new Candidate("B Consv Log10 2013-2014",    "010001100101011110011110011011", asList(BollingerBandsGenerator.class, RelativeStrengthIndexGenerator.class)),
                new Candidate("B Consv Log10 2013-2014",    "010001100100001110010101101001", asList(BollingerBandsGenerator.class, RelativeStrengthIndexGenerator.class)),
                ...
                new Candidate("B Conservative 2014",        "100101100100111110100110011010", asList(BollingerBandsGenerator.class, AroonOscilatorGenerator.class)),
                ...
                new Candidate("B Consv LogE 2013-2014",     "100001000011110001000010101110", asList(BollingerBandsGenerator.class, AroonOscilatorGenerator.class)),
                new Candidate("B Consv Log10 2013-2014",    "011101000101110011000011010110", asList(BollingerBandsGenerator.class, AroonOscilatorGenerator.class)),
                new Candidate("C Consv Log10 2013-2014",    "100101001010110111001100000100", asList(BollingerBandsGenerator.class, AroonOscilatorGenerator.class)),
                ...
                new Candidate("X Conservative 2012-2014", "11110111110100110", asList(AroonOscilatorGenerator.class)),


                new Candidate("C 3 Decisions <75 filter 2013-2014", "1100001111000100101010011001010010010110100",
                ...
                new Candidate("B 3 Decisions <75 filter 2013-2014", "1011011000111000100011010110000000010011110",
                ...
                new Candidate("B 3 Decisions <75 filter 2013-2014", "1100011000101110100011000010000011010001100",
                    asList(MovingAverageConvergenceDivergenceGenerator.class, AroonOscilatorGenerator.class, MoneyFlowIndexGenerator.class)),
                new Candidate("C 3 Decisions <75 filter 2013-2014", "1110011001000111100101101010110001110101101",
                    asList(BollingerBandsGenerator.class, RelativeStrengthIndexGenerator.class, MoneyFlowIndexGenerator.class)),
                new Candidate("C 3 Decisions <75 filter 2013-2014", "1110011000101111100011010000100100010010011",
                    asList(BollingerBandsGenerator.class, AroonOscilatorGenerator.class, MoneyFlowIndexGenerator.class)),
                new Candidate("C 3 Decisions <75 filter 2013-2014", "1110011001101011100010001011010001110010011",
                ...
                new Candidate("B 3 Decisions <75 filter 2013-2014", "1100111101000001101100010101000100010001100",
                    asList(BollingerBandsGenerator.class, MovingAverageConvergenceDivergenceGenerator.class, MoneyFlowIndexGenerator.class)),
                new Candidate("B 3 Decisions <75 filter 2013-2014", "1100000101001111101100010110000100010001100",
                ...
                new Candidate("B 3 Decisions <75 filter 2013-2014", "1100000101001000001100001100110000101011000",
