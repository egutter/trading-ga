...
//    }
//
//    private BitString runOneStrategy(StockMarket stockMarket, List<? extends Class<? extends ConditionalOrderConditionGenerator>> tradingDecisionGenerators) {
//        System.out.println("=============================================");
//
...
//
//
//    private static void printResults(StockMarket stockMarket, BitString result, List<? extends Class<? extends ConditionalOrderConditionGenerator>> tradingDecisionGenerators) {
//        OneCandidateRunner runner = new OneCandidateRunner(stockMarket, result, tradingDecisionGenerators);
//        runner.run();
